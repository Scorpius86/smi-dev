Vue.component("vue-panel-edicion", {
                    ...
                    <template v-if="tipo=='grafico'">
                        ...
                        <ul class="nav nav-pills mb-3" role="tablist">
                            ...
                            <li v-for="cultivo in detalle.cultivos" class="nav-item">
                                <a class="nav-link active" v-bind:id="'cultivo-' + cultivo.id + '-tab'" data-toggle="pill" v-on:click="seleccionCultivo(cultivo.id)"
  ...
  methods: {
    ...
    onSeleccionarPanelFeature: function() {
      ...
      mapFeature.loadPanel(this.input.seccion.id, lista, this.selCultivo, function(data){
        me.detalle= data;
        me.show();
      });
    }
